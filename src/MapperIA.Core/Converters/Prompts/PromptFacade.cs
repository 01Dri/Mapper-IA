...
public class PromptFacade
{
    ...
    private string FileClassConverterPrompt()
    {
        return
            ...
            $"6. If the namespace value is not null, set the C# class with the following namespace declaration: 'namespace value => {NameSpaceValue};' (without braces). Ensure the namespace is in the standard C# format. If the namespace value is null, omit the namespace declaration entirely. \n" +
